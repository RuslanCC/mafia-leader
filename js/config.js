...
$(document).ready(function() {
	...
	$arRoles[2]='Мафия';$arRoles[3]='Мафия';$arRoles[4]='Комиссар';$arRoles[5]='Доктор';
	$arRoles[6]='Путана';$arRoles[7]='Маньяк';//$arRoles[3]='Босс';$arRoles[8]='Бессмертный';$arRoles[9]='Вор';$arRoles[10]='Смертник';
